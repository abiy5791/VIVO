      ...
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8 dark:text-slate-400">
        ...
        <div className="mt-16 justify-center gap-6 sm:grid sm:grid-cols-2 sm:space-y-0 lg:grid-cols-3">
          {plans.map((item, idx) => (
            ...
            >
              {item.isMostPop ? (
                <span class="border-indigo-600 w-32 absolute -top-5 left-0 right-0 mx-auto px-3 py-2 rounded-full border shadow-md bg-white text-center text-gray-700 text-sm font-semibold">
                  Most popular
                </span>
              ) : (
                ""
              ...
              <ul className="p-8 space-y-3">
                <li className="pb-2 text-gray-800 font-medium dark:text-slate-300 ">
                  <p>Features</p>
                </li>
