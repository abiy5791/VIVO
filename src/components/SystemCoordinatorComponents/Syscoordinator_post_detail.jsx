        ...
        <div class="lg:w-4/6 mx-auto bg-slate-50 p-6 rounded-xl">
          <div class="rounded-lg h-64 overflow-hidden">
            <img
              ...
              src="https://images.unsplash.com/photo-1594904351111-a072f80b1a71?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            />
          </div>
                      ...
                      <ul className="space-y-4">
                        ...
                        <li className="space-y-1">
                          <div className="flex items-center space-x-2">
                            ...
                            <h4 className="font-medium">
                              Task 2: Use JPMorgan Chase & Co. frameworks and
                              tools
                            </h4>
                          </div>
                          <p className="ml-7 dark:text-gray-400">
                            Illum hic placeat unde porro, cupiditate nesciunt?
