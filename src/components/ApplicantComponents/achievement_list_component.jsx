              ...
              <li className="space-y-1">
                <div className="flex items-center space-x-2">
                  ...
                  <h4 className="font-medium">
                    Application Dates, Locations and Eligibility Criteria
                  </h4>
                </div>
                <p className="ml-7 dark:text-gray-400">Unlocked!</p>
              </li>
              <li className="space-y-1">
                <div className="flex items-center space-x-2">
                  <svg
                  ...
                  <h4 className="font-medium">Resume snippet</h4>
                </div>
                <p className="ml-7 dark:text-gray-400">Unlocked!</p>
              </li>
              <li className="space-y-1">
                <div className="flex items-center space-x-2">
                  ...
                  <h4 className="font-medium">Interview tip</h4>
                </div>
                <p className="ml-7 dark:text-gray-400">Unlocked!</p>
              </li>
              <li className="space-y-1">
