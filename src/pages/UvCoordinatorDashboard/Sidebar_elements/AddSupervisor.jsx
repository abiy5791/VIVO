...
console.log("hell")
  ...
  return (
    ...
    <div className="flex flex-col text-center w-full mb-12">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Add University Supervisor</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">When filling in the supervisor's details, provide accurate and complete information. This section helps verify your background and experience.</p>
    </div>
   <Form
      {...formItemLayout}
      form={form}
...
<Form.Item
      ...
      >
        <Select placeholder="Select your University">
          <Option value="Astu">Adama Science and Technology Universiy</Option>
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: 'Please input University Department!' }]}
      >
        <Input />
      </Form.Item>
      <Form.Item
        ...
        rules={[{ required: true, message: 'Please input Specialization Field!' }]}
      >
        <Input />
      </Form.Item>
      <Form.Item
    ...
    <Form.Item
        ...
        rules={[{ required: false, message: 'Please select your profile number!' }]}
      >
